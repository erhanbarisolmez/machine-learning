...
#veri kümesi 
dataset = pd.read_csv('btk-makine/data/Social_Network_Ads.csv')
...
'''
gs = GridSearchCV(estimator=classifier,  #SVM algoritması optimize edilecek
                  param_grid=p,
                  scoring='accuracy',
                  cv=10,
                  n_jobs=-1)
